...
// 8 wheel slices configured with 0.002 GRAM and 0.001 USDT (50% combined drop chance)
const SLICES: WheelSlice[] = [
  ...
  { id: 5, label: '0.002 GRAM', sublabel: 'Bonus Drop', icon: '🪙', color1: '#2d1a0a', color2: '#42260f', textColor: '#f59e0b', weight: 1.0, type: 'gram', amount: 0.002 },
  { id: 6, label: '0.001 USDT', sublabel: 'Lucky Cash', icon: '💵', color1: '#09361c', color2: '#12572e', textColor: '#22c55e', weight: 0.5, type: 'usdt', amount: 0.001 },
  { id: 7, label: '0.01 GRAM', sublabel: '★ JACKPOT ★', icon: '👑', color1: '#3d1d05', color2: '#5e2d09', textColor: '#ffd700', weight: 0.5, type: 'gram', amount: 0.01 },
]
